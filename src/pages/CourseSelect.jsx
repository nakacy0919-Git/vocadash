...
export default function CourseSelect({ onSelectCourse }) {
  return (
    <div className="h-screen w-screen bg-macaron-gradient p-4 md:p-6 flex flex-col items-center justify-center overflow-y-auto font-sans">
      ...
      {/* コース選択グリッド（正方形ボタン） */}
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 w-full max-w-4xl px-2 md:px-4 pb-16">
        {CATEGORIES.map(cat => (
          <button
            key={cat.id}
